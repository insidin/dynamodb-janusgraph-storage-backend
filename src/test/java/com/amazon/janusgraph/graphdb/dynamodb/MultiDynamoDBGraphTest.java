...
public class MultiDynamoDBGraphTest extends AbstractDynamoDBGraphTest {
    ...
    // 's/.*\ name=\"\([^\"]*\)\".*/\ \ \ \ @Tag("\ MultiDynamoDBGraphTestCategory.class\ })\ public\ void\ \1()\ {\ super\.\1();\ }/'

    @Test
    @Override
    @Tag("MultiDynamoDBGraphTestCategory.class")
    ...
    @Test
    @Override
    @Tag("IsolateMultiLargeJointIndexRetrieval.class")
    @Tag("MultipleItemTestCategory.class")
    ...
    @Test
    @Override
    @Tag("MultiDynamoDBGraphTestCategory")
    @Tag("MultipleItemTestCategory.class")
    ...
    */
    ...
    @Test
    @Override
    @Tag("IsolateMultiVertexCentricQuery.class")
    @Tag("MultipleItemTestCategory.class")
    ...
    @Test
    @Override
    @Tag("IsolateMultiEdgesExceedCacheSize.class")
    @Tag("MultipleItemTestCategory.class")
